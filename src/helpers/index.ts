...
export const caculateAPR = (tokenPerSecond: number, totalStake: number, type = 'YOUR_TOKEN_NAME') => {
  if (type === 'YOUR_TOKEN_NAME') {
...
export const caculateYieldAPR = (tokenPerSecond: number, totalStake: number) => {
